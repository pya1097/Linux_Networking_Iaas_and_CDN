...
yaml_archive_file_path = os.path.join(current_directory, '../archive/automation/variables/create_vm_variables_'+str(sn_id)+'.yml')
...
playbook_path = '../automation/ansible_create_subnet.yaml'
